...
${OBJECTDIR}/NodoColumnaAux.o: NodoColumnaAux.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NodoColumnaAux.o NodoColumnaAux.cpp
...
${OBJECTDIR}/columnasData.o: columnasData.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/columnasData.o columnasData.cpp
...
${OBJECTDIR}/seleccion.o: seleccion.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/seleccion.o seleccion.cpp
