...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/database

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/database: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/database ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/ArbolBinario.o: ArbolBinario.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ArbolBinario.o ArbolBinario.cpp

${OBJECTDIR}/BinaryThreeForChar.o: BinaryThreeForChar.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BinaryThreeForChar.o BinaryThreeForChar.cpp

${OBJECTDIR}/BinaryThreeForFloat.o: BinaryThreeForFloat.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BinaryThreeForFloat.o BinaryThreeForFloat.cpp

${OBJECTDIR}/BinaryThreeForInt.o: BinaryThreeForInt.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BinaryThreeForInt.o BinaryThreeForInt.cpp

${OBJECTDIR}/BinaryThreeForString.o: BinaryThreeForString.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/BinaryThreeForString.o BinaryThreeForString.cpp
...
${OBJECTDIR}/NuevaTabla.o: NuevaTabla.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NuevaTabla.o NuevaTabla.cpp
...
${OBJECTDIR}/columnasData.o: columnasData.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/columnasData.o columnasData.cpp
...
${OBJECTDIR}/mensajes.o: mensajes.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
